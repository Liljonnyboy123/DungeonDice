...
//  DungeonDice
//
//  Created by GUZMAN, JOSHUA on 2/9/26.
//
        ...
        VStack {
            ...
            Text(resultMessage)
                ...
                .onChange(of: animationTrigger) {
                    isDoneAnimating = false // set to beginning fals syaye right away
            ...
            LazyVGrid(columns: [GridItem(.adaptive(minimum: 100, maximum: 102))]) {
                ForEach(Dice.allCases) { dice in
                    Button(dice.description) {
                        ...
                        animationTrigger.toggle() // a change of ths value triggers an animation
                    }
            }
